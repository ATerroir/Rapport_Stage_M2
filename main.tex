...
\hspace{-3cm}
\vspace{1.2cm}
\includegraphics[scale=0.9]{logo_LAUM.pdf}\\[1cm]  
\end{minipage}
\begin{minipage}[c]{0.4\linewidth}
\centering
\hspace{-1cm}
...
\hspace{1.3cm}
\vspace{0.5cm}
\includegraphics[scale=0.5]{Logo_LeMansUniv.pdf}\\[1cm]  
\end{minipage}
\end{titlepage}
%----------------------------------------------------------------------------------------
\begin{abstract}
