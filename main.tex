...
\section{Conclusion}
\label{Ch_Inv_S_Conc}
    Une méthode inverse a pu être développé pour retrouver les paramètres du fluides équivalent a partir de la longueur de la couche fluide selon $x_3$ et de 6 couples R/T pour 6 angles d'incidence différent, les 6 angles étant :\\
    ...
    La méthode peut se diviser en 5 étapes de résolutions listé ci-dessous 
    \begin{itemize}
        ...
        \item 3) Identification des trois densités du plan $\rho_1$, $\rho_2$ et $\rho_{12}$ avec 3 angles d'incidence selon $x_1$, $x_2$ et médian.
...
\label{Ch_Res}
  \begin{figure}[ht!]
        \centering
        \includegraphics{Material_2.png}
